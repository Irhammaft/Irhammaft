...
TC_DIR="/content/drive/compiler/clang"
GCC_64_DIR="/content/drive/compiler/64"
GCC_32_DIR="/content/drive/compiler/32"
AK3_DIR="/content/drive/compiler/AnyKernel3"
...
export KBUILD_COMPILER_STRING="/content/drive/compiler/clang/bin/clang --version | head -n 1 | perl -pe 's/\(http.*?\)//gs' | sed -e 's/  */ /g' -e 's/[[:space:]]*$//')"
